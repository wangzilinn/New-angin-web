      ...
      <el-col :xs="22" :sm="22" :md="12" :lg="12" :xl="12"><article class="main-content page-page">
        ...
        <div class="post-content" itemprop="articleBody">
          <p class="post-tags" v-if="article.tagNames != null">
            <a v-for="tagName in article.tagNames" href="#" :key="tagName">{{tagName}}</a>
          </p>
  ...
  methods: {
    ...
    initDirectory() {
      ...
      var postDirectoryBuild = function () {
        ...
        var createPostDirectory = function (article:any, directory:any, isDirNum:any) {
          ...
          for (i = 0, len = levelArr.length; i < len; i++) {
            ...
            if (level === 1) {
              ...
              if (currentList!==null && currentList.lastElementChild!==null){
